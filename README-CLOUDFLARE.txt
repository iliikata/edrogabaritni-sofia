...
FIX:
- Мобилните пунктове използват опростени адреси за геокодиране и стандартни Google markers.
- Отделната карта показва броя успешно позиционирани пунктове.
- Ако в избраното каре няма официални контейнери, сайтът не измисля такива; предлага бутон за най-близките до 800 м извън карето.
